...
import com.microservicio1.microservicio1.DTO.MarcaDTO;
import com.microservicio1.microservicio1.model.Marca;
import com.microservicio1.microservicio1.service.MarcaService;
...
public class MarcaController {
    ...
    public ResponseEntity<MarcaDTO> buscarPorId(@PathVariable Integer id){
        MarcaDTO marcas = marcaService.buscarPorId(id);
        return new ResponseEntity<>(marcas, HttpStatus.OK); 
    }
